...
class ShellRendererTests(unittest.TestCase):
    ...
    def test_current_profile_and_fail_closed_inputs(self):
        ...
        cases = (
            ...
            (input_text.replace("META\troute_table\t354", "META\troute_table\t0x162"), 66),
            (input_text.replace("META\troute_table\t354", "META\troute_table\t355"), 66),
            (input_text.replace("META\troute_table\t354", "META\troute_table\t0"), 66),
            (input_text.replace("META\troute_table\t354", "META\troute_table\t"), 66),
            (input_text.replace("META\troute_table\t354", "META\troute_table\tabc"), 66),
            (input_text.replace("META\tmark\t0x162", "META\tmark\t0x163"), 66),
            (input_text.replace("META\tmask\t0xffffffff", "META\tmask\t0xfffffffe"), 66),
            (input_text.replace("META\trule_pref\t1888", "META\trule_pref\t1889"), 66),
