...
s.extedit = DISP.build_url("admin/services/openkill/config-subscribe-edit/%s")
function s.create(...)
...
o.template = "openkill/update_config"
...
o.write = function()
	...
	m.uci:commit("openkill")
	SYS.call("/usr/share/openkill/openkill.sh >/dev/null 2>&1 &")
