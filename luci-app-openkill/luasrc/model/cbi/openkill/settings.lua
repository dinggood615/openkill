...
m.pageaction = false
m.description = translate("Note: To restore the default configuration, try accessing:").." <a href='javascript:void(0)' onclick='javascript:restore_config(this)'>http://"..lan_ip.."/cgi-bin/luci/admin/services/openkill/restore</a>"..
...
o.description = translate("Move Core And GEOIP Data File To /tmp/etc/openkill For Small Flash Memory Device")
o.default = 0

---- Operation Mode
switch_mode = s:taboption("op_mode", DummyValue, "", nil)
switch_mode.template = "openkill/switch_mode"
...
o.description = translate("If DNS is abnormal after stopping the OpenKill, please try to fix")
...
function custom_domain_dns.cfgvalue(self, section)
	return fs.readfile("/etc/openkill/custom/openkill_custom_domain_dns.list") or ""
end
function custom_domain_dns.write(self, section, value)
	if value then
		value = value:gsub("\r\n?", "\n")
		local old_value = fs.readfile("/etc/openkill/custom/openkill_custom_domain_dns.list")
	if value ~= old_value then
			fs.writefile("/etc/openkill/custom/openkill_custom_domain_dns.list", value)
		end
	end
	return true
end
...
if string.len(SYS.exec("/usr/share/openkill/openkill_get_network.lua 'gateway6'")) ~= 0 then
...
function o.cfgvalue(self, section)
	return fs.readfile("/etc/openkill/custom/openkill_custom_localnetwork_ipv4.list") or ""
end
function o.write(self, section, value)
	if value then
		value = value:gsub("\r\n?", "\n")
		local old_value = fs.readfile("/etc/openkill/custom/openkill_custom_localnetwork_ipv4.list")
		if value ~= old_value then
			fs.writefile("/etc/openkill/custom/openkill_custom_localnetwork_ipv4.list", value)
		end
	end
	return true
end
...
function o.cfgvalue(self, section)
	return fs.readfile("/etc/openkill/custom/openkill_custom_chnroute_pass.list") or ""
end
function o.write(self, section, value)
	if value then
		value = value:gsub("\r\n?", "\n")
		local old_value = fs.readfile("/etc/openkill/custom/openkill_custom_chnroute_pass.list")
		if value ~= old_value then
			fs.writefile("/etc/openkill/custom/openkill_custom_chnroute_pass.list", value)
		end
	end
	return true
end
...
o.inputstyle = "reload"
o.write = function()
	SYS.call("rm -rf /etc/openkill/history/streaming_unlock_cache >/dev/null 2>&1 &")
end
...
o.description = translate("Current Version:").." "..font_green..bold_on..fs.get_resourse_mtime("/etc/openkill/Country.mmdb")..bold_off..font_off
o.inputtitle = translate("Check And Update")
o.inputstyle = "reload"
o.write = function()
	m.uci:set("openkill", "config", "enable", 1)
	m.uci:commit("openkill")
	SYS.call("/usr/share/openkill/openkill_geo.sh ipdb >/dev/null 2>&1 &")
...
o.description = translate("Current Version:").." "..font_green..bold_on..fs.get_resourse_mtime("/etc/openkill/GeoIP.dat")..bold_off..font_off
o.inputtitle = translate("Check And Update")
o.inputstyle = "reload"
o.write = function()
	m.uci:set("openkill", "config", "enable", 1)
	m.uci:commit("openkill")
	SYS.call("/usr/share/openkill/openkill_geo.sh geoip >/dev/null 2>&1 &")
	HTTP.redirect(DISP.build_url("admin", "services", "openkill"))
end
...
o.description = translate("Current Version:").." "..font_green..bold_on..fs.get_resourse_mtime("/etc/openkill/GeoSite.dat")..bold_off..font_off
o.inputtitle = translate("Check And Update")
o.inputstyle = "reload"
o.write = function()
	m.uci:set("openkill", "config", "enable", 1)
	m.uci:commit("openkill")
	SYS.call("/usr/share/openkill/openkill_geo.sh geosite >/dev/null 2>&1 &")
	HTTP.redirect(DISP.build_url("admin", "services", "openkill"))
end
...
o.description = translate("Current Version:").." "..font_green..bold_on..fs.get_resourse_mtime("/etc/openkill/ASN.mmdb")..bold_off..font_off
o.inputtitle = translate("Check And Update")
o.inputstyle = "reload"
o.write = function()
	m.uci:set("openkill", "config", "enable", 1)
	m.uci:commit("openkill")
	SYS.call("/usr/share/openkill/openkill_geo.sh geoasn >/dev/null 2>&1 &")
	HTTP.redirect(DISP.build_url("admin", "services", "openkill"))
end
...
o.description = translate("Current Version:").." "..font_green..bold_on.. "IPv4 ("..fs.get_resourse_mtime("/etc/openkill/china_ip_route.ipset")..")"..bold_off..font_off.." "..font_green..bold_on.. "& IPv6 ("..fs.get_resourse_mtime("/etc/openkill/china_ip6_route.ipset")..")"..bold_off..font_off
o.inputtitle = translate("Check And Update")
o.inputstyle = "reload"
o.write = function()
	m.uci:set("openkill", "config", "enable", 1)
	m.uci:commit("openkill")
	SYS.call("/usr/share/openkill/openkill_chnroute.sh >/dev/null 2>&1 &")
	HTTP.redirect(DISP.build_url("admin", "services", "openkill"))
end

o = s:taboption("auto_restart", Flag, "auto_restart", translate("Auto Restart"))
o.description = translate("Auto Restart OpenKill")
o.default = 0
...
o.template="openkill/switch_dashboard"
o.rawhtml = true
...
function o.cfgvalue(self, section)
	return fs.readfile("/etc/openkill/custom/openkill_custom_localnetwork_ipv6.list") or ""
end
function o.write(self, section, value)
	if value then
		value = value:gsub("\r\n?", "\n")
		local old_value = fs.readfile("/etc/openkill/custom/openkill_custom_localnetwork_ipv6.list")
		if value ~= old_value then
			fs.writefile("/etc/openkill/custom/openkill_custom_localnetwork_ipv6.list", value)
		end
	end
	return true
end
...
function o.cfgvalue(self, section)
	return fs.readfile("/etc/openkill/custom/openkill_custom_chnroute6_pass.list") or ""
end
function o.write(self, section, value)
	if value then
		value = value:gsub("\r\n?", "\n")
		local old_value = fs.readfile("/etc/openkill/custom/openkill_custom_chnroute6_pass.list")
		if value ~= old_value then
			fs.writefile("/etc/openkill/custom/openkill_custom_chnroute6_pass.list", value)
		end
	end
	return true
end
...
function o.cfgvalue(self, section)
	return fs.readfile("/etc/openkill/custom/openkill_custom_firewall_rules.sh") or ""
end
function o.write(self, section, value)
	if value then
		value = value:gsub("\r\n?", "\n")
		local old_value = fs.readfile("/etc/openkill/custom/openkill_custom_firewall_rules.sh")
		if value ~= old_value then
			fs.writefile("/etc/openkill/custom/openkill_custom_firewall_rules.sh", value)
		end
	end
	return true
end
