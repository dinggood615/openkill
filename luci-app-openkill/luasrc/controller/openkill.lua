module("luci.controller.openkill", package.seeall)

function index()
	if not nixio.fs.access("/etc/config/openkill") then
		return
	end

	local page

	page = entry({"admin", "services", "openkill"}, alias("admin", "services", "openkill", "client"), _("OpenKill"), 50)
	page.dependent = true
	page.acl_depends = { "luci-app-openkill" }
	...
	entry({"admin", "services", "openkill", "del_start_log"},call("action_del_start_log"))
	entry({"admin", "services", "openkill", "close_all_connection"},call("action_close_all_connection"))
	entry({"admin", "services", "openkill", "reload_firewall"},call("action_reload_firewall"))
	entry({"admin", "services", "openkill", "save_corever_branch"},call("action_save_corever_branch"))
	entry({"admin", "services", "openkill", "update"},call("action_update"))
	entry({"admin", "services", "openkill", "last_version"},call("action_last_version"))
	...
	entry({"admin", "services", "openkill", "backup"}, call("action_backup"))
	entry({"admin", "services", "openkill", "backup_ex_core"}, call("action_backup_ex_core"))
	entry({"admin", "services", "openkill", "backup_only_core"}, call("action_backup_only_core"))
	entry({"admin", "services", "openkill", "backup_only_config"}, call("action_backup_only_config"))
	entry({"admin", "services", "openkill", "backup_only_rule"}, call("action_backup_only_rule"))
	entry({"admin", "services", "openkill", "backup_only_proxy"}, call("action_backup_only_proxy"))
	entry({"admin", "services", "openkill", "remove_all_core"}, call("action_remove_all_core"))
	entry({"admin", "services", "openkill", "one_key_update"}, call("action_one_key_update"))
	entry({"admin", "services", "openkill", "one_key_update_check"}, call("action_one_key_update_check"))
	entry({"admin", "services", "openkill", "switch_mode"}, call("action_switch_mode"))
	entry({"admin", "services", "openkill", "op_mode"}, call("action_op_mode"))
	entry({"admin", "services", "openkill", "sub_info_get"}, call("sub_info_get"))
	entry({"admin", "services", "openkill", "config_name"}, call("action_config_name"))
	...
	entry({"admin", "services", "openkill", "switch_log"}, call("action_switch_log"))
	entry({"admin", "services", "openkill", "rule_mode"}, call("action_rule_mode"))
	entry({"admin", "services", "openkill", "switch_rule_mode"}, call("action_switch_rule_mode"))
	entry({"admin", "services", "openkill", "switch_run_mode"}, call("action_switch_run_mode"))
	entry({"admin", "services", "openkill", "dashboard_type"}, call("action_dashboard_type"))
	entry({"admin", "services", "openkill", "switch_dashboard"}, call("action_switch_dashboard"))
	entry({"admin", "services", "openkill", "delete_dashboard"}, call("action_delete_dashboard"))
	entry({"admin", "services", "openkill", "default_dashboard"}, call("action_default_dashboard"))
	...
	entry({"admin", "services", "openkill", "proxy-provider-file-manage"},form("openkill/proxy-provider-file-manage"), nil).leaf = true
	entry({"admin", "services", "openkill", "rule-providers-file-manage"},form("openkill/rule-providers-file-manage"), nil).leaf = true
	entry({"admin", "services", "openkill", "config-subscribe-edit"},cbi("openkill/config-subscribe-edit"), nil).leaf = true
	entry({"admin", "services", "openkill", "servers-config"},cbi("openkill/servers-config"), nil).leaf = true
	entry({"admin", "services", "openkill", "groups-config"},cbi("openkill/groups-config"), nil).leaf = true
	entry({"admin", "services", "openkill", "proxy-provider-config"},cbi("openkill/proxy-provider-config"), nil).leaf = true
	entry({"admin", "services", "openkill", "config"},form("openkill/config"),_("Config Manage"), 80).leaf = true
	entry({"admin", "services", "openkill", "log"},cbi("openkill/log"),_("Server Logs"), 90).leaf = true
	entry({"admin", "services", "openkill", "myip_check"}, call("action_myip_check"))
	entry({"admin", "services", "openkill", "website_check"}, call("action_website_check"))
	entry({"admin", "services", "openkill", "version_history"}, call("action_version_history"))
	entry({"admin", "services", "openkill", "addr_info"}, call("action_cdn_info"))
	entry({"admin", "services", "openkill", "save_github_address_mod"}, call("action_save_github_address_mod"))
	entry({"admin", "services", "openkill", "proxy_info"}, call("action_proxy_info"))
	entry({"admin", "services", "openkill", "oc_settings"}, call("action_oc_settings"))
	entry({"admin", "services", "openkill", "switch_oc_setting"}, call("action_switch_oc_setting"))
	entry({"admin", "services", "openkill", "generate_pac"}, call("action_generate_pac"))
	entry({"admin", "services", "openkill", "action"}, call("action_oc_action"))
	entry({"admin", "services", "openkill", "config_file_list"}, call("action_config_file_list"))
	entry({"admin", "services", "openkill", "config_file_read"}, call("action_config_file_read"))
	entry({"admin", "services", "openkill", "config_file_save"}, call("action_config_file_save"))
	entry({"admin", "services", "openkill", "upload_config"}, call("action_upload_config"))
	entry({"admin", "services", "openkill", "add_subscription"}, call("action_add_subscription"))
	entry({"admin", "services", "openkill", "subconverter_version"}, call("action_subconverter_version"))
	entry({"admin", "services", "openkill", "generate_age_key"}, call("action_generate_age_key"))
	entry({"admin", "services", "openkill", "cal_age_public_key"}, call("action_cal_age_public_key"))
	entry({"admin", "services", "openkill", "add_age_config"}, call("action_add_age_config"))
	entry({"admin", "services", "openkill", "upload_overwrite"}, call("action_upload_overwrite"))
	entry({"admin", "services", "openkill", "overwrite_subscribe_info"}, call("action_overwrite_subscribe_info"))
	entry({"admin", "services", "openkill", "overwrite_file_list"}, call("action_overwrite_file_list"))
...
local function is_start()
	return process_status("/etc/init.d/openkill")
end
...
local ov = dofile("/usr/share/openkill/openkill_version.lua")
...
local function opcv()
	local v
	local info = opkg and opkg.info("luci-app-openkill")
	if info and info["luci-app-openkill"] and info["luci-app-openkill"]["Version"] and info["luci-app-openkill"]["Installed-Time"] then
		v = info["luci-app-openkill"]["Version"]
	else
		if fs.pkg_type() == "opkg" then
			v = fs.read_pkg_field("luci-app-openkill", "Version")
		else
			v = fs.read_pkg_field("luci-app-openkill", "V"):match("[%d%.]+") or ""
		end
	end
	if v and v ~= "" then
		return "v" .. v
...
local function opup()
	return SYS.call("bash /usr/share/openkill/openkill_update.sh >/dev/null 2>&1 &")
end
...
local function save_corever_branch()
	if HTTP.formvalue("core_ver") then
		uci:set("openkill", "config", "core_version", HTTP.formvalue("core_ver"))
	end
...
function core_download()
	...
	if download_url and download_url ~= "" then
		...
		SYS.call(string.format("bash /usr/share/openkill/openkill_core.sh '%s' >/dev/null 2>&1 &", core_type))
	end
...
function action_update_config()
	...
	local update_result = SYS.call(string.format("/usr/share/openkill/openkill.sh '%s' >/dev/null 2>&1", filename))
...
function action_restore_config()
	...
	uci:commit("openkill")
	SYS.call("mkdir -p /etc/openkill/custom >/dev/null 2>&1")
	SYS.call("mkdir -p /etc/openkill/overwrite >/dev/null 2>&1")
	SYS.call("mkdir -p /etc/openkill/rule_provider >/dev/null 2>&1")
	SYS.call("/etc/init.d/openkill stop >/dev/null 2>&1")
	SYS.call("cp -f /usr/share/openkill/backup/openkill /etc/config/openkill >/dev/null 2>&1 &")
	SYS.call("cp -f /usr/share/openkill/backup/openkill_custom* /etc/openkill/custom/ >/dev/null 2>&1 &")
	SYS.call("cp -f /usr/share/openkill/backup/openkill_force_sniffing* /etc/openkill/custom/ >/dev/null 2>&1 &")
	SYS.call("cp -f /usr/share/openkill/backup/openkill_sniffing* /etc/openkill/custom/ >/dev/null 2>&1 &")
	SYS.call("cp -f /usr/share/openkill/backup/china_ip_route.ipset /etc/openkill/china_ip_route.ipset >/dev/null 2>&1 &")
	SYS.call("cp -f /usr/share/openkill/backup/china_ip6_route.ipset /etc/openkill/china_ip6_route.ipset >/dev/null 2>&1 &")
	SYS.call("cp -f /usr/share/openkill/backup/overwrite/default /etc/openkill/overwrite/default >/dev/null 2>&1 &")
	SYS.call("cp -f /usr/share/openkill/backup/oc-cn-domain.mrs /etc/openkill/rule_provider/oc-cn-domain.mrs >/dev/null 2>&1 &")
	SYS.call("rm -rf /etc/openkill/history/* >/dev/null 2>&1 &")
end

function action_remove_all_core()
	SYS.call("rm -rf /etc/openkill/core/* >/dev/null 2>&1")
end
...
function action_one_key_update()
	...
	if update_type == "plugin" then
		if download_url and download_url ~= "" then
			return SYS.call(string.format("bash /usr/share/openkill/openkill_update.sh 'plugin_update' '%s' '%s' >/dev/null 2>&1 &",
				cdn_url or "", download_url))
		elseif cdn_url and cdn_url ~= "" then
			return SYS.call(string.format("bash /usr/share/openkill/openkill_update.sh 'plugin_update' '%s' >/dev/null 2>&1 &", cdn_url))
		else
			return SYS.call("bash /usr/share/openkill/openkill_update.sh 'plugin_update' >/dev/null 2>&1 &")
		end
	end

	if download_url and download_url ~= "" then
		-- Full download URL: pass as $3 to the update script
		return SYS.call(string.format("bash /usr/share/openkill/openkill_update.sh 'one_key_update' '%s' '%s' >/dev/null 2>&1 &",
			cdn_url or "", download_url))
	elseif cdn_url and cdn_url ~= "" then
		return SYS.call(string.format("bash /usr/share/openkill/openkill_update.sh 'one_key_update' '%s' >/dev/null 2>&1 &", cdn_url))
	else
		return SYS.call("bash /usr/share/openkill/openkill_update.sh 'one_key_update' >/dev/null 2>&1 &")
	end
end

local function config_name()
	local e,a={}
	for t,o in ipairs(fs.glob("/etc/openkill/config/*"))do
		a=fs.stat(o)
		if a then
			e[t]={}
...
function action_switch_config()
	...
	if not config_file and config_name then
		config_file = "/etc/openkill/config/" .. config_name
	end
	...
	uci:set("openkill", "config", "config_path", config_file)
	uci:set("openkill", "config", "enable", "1")
	uci:commit("openkill")
...
function set_subinfo_url()
	...
	if not info then
		uci:foreach("openkill", "subscribe_info",
			function(s)
				if s.name == filename then
					if not url or url == "" then
						uci:delete("openkill", s[".name"])
						uci:commit("openkill")
						info = "Delete success"
						return false
					else
						...
						uci:delete("openkill", s[".name"], "url")
						uci:set_list("openkill", s[".name"], "url", url_list)
						uci:commit("openkill")
						info = "Success"
						return false
					end
		...
		if not info then
			if not url or url == "" then
				...
				uci:section("openkill", "subscribe_info", nil, {name = filename, url = url_list})
				uci:commit("openkill")
				info = "Success"
			end
		end
...
function get_sub_url(filename)
	...
	local config_path = "/etc/openkill/config/" .. fs.basename(filename .. ".yaml")
	...
	uci:foreach("openkill", "config_subscribe",
		function(s)
			if s.name == filename then
				...
				local raw = uci:get_list("openkill", s['.name'], "sub_headers")
				if raw then
...
function action_switch_rule_mode()
	...
	uci:set("openkill", "config", "proxy_mode", mode)
	uci:set("openkill", "@overwrite[0]", "proxy_mode", mode)
	uci:commit("openkill")
end
...
function action_switch_run_mode()
	...
	if operation_mode == "redir-host" then
		uci:set("openkill", "config", "en_mode", "redir-host"..mode)
		uci:set("openkill", "@overwrite[0]", "en_mode", "redir-host"..mode)
	elseif operation_mode == "fake-ip" then
		uci:set("openkill", "config", "en_mode", "fake-ip"..mode)
		uci:set("openkill", "@overwrite[0]", "en_mode", "fake-ip"..mode)
	end
	uci:commit("openkill")
	if is_running() then
		SYS.exec("/etc/init.d/openkill restart >/dev/null 2>&1 &")
	end
end
...
function action_dashboard_type()
	...
	HTTP.write_json({
		...
		yacd_type = yacd_type,
		yacd = fs.isdirectory("/usr/share/openkill/ui/yacd"),
		dashboard = fs.isdirectory("/usr/share/openkill/ui/dashboard"),
...
function action_default_dashboard()
	...
	if not fs.isdirectory("/usr/share/openkill/ui/" .. string.lower(default_dashboard)) then
		HTTP.status(500, "Set Failed")
		return
	end
	uci:set("openkill", "config", "default_dashboard", string.lower(default_dashboard))
	uci:commit("openkill")
	HTTP.prepare_content("application/json")
	HTTP.write_json({
		default_dashboard = default_dashboard;
...
function action_switch_dashboard()
	...
	local state = SYS.call(string.format('/usr/share/openkill/openkill_download_dashboard.sh "%s" "%s" >/dev/null 2>&1', switch_name, switch_type))
	if switch_name == "Dashboard" and tonumber(state) == 0 then
		if switch_type == "Official" then
			uci:set("openkill", "config", "dashboard_type", "Official")
			uci:commit("openkill")
		else
			uci:set("openkill", "config", "dashboard_type", "Meta")
			uci:commit("openkill")
		end
	elseif switch_name == "Yacd" and tonumber(state) == 0 then
		if switch_type == "Official" then
			uci:set("openkill", "config", "yacd_type", "Official")
			uci:commit("openkill")
		else
			uci:set("openkill", "config", "yacd_type", "Meta")
			uci:commit("openkill")
		end
	end
	HTTP.prepare_content("application/json")
...
function action_delete_dashboard()
	...
	local delete_path = string.format("/usr/share/openkill/ui/%s", string.lower(delete_name))

	local panels = {
		"/usr/share/openkill/ui/dashboard",
		"/usr/share/openkill/ui/yacd",
		"/usr/share/openkill/ui/metacubexd",
		"/usr/share/openkill/ui/zashboard"
	}
	...
	if tonumber(state) == 1 then
		...
		if fs.uci_get_config("config", "default_dashboard") == string.lower(delete_name) then
			uci:set("openkill", "config", "default_dashboard", "")
			uci:commit("openkill")
		end
	end
	HTTP.prepare_content("application/json")
...
function action_switch_mode()
	...
	if switch_mode == "redir-host" then
		uci:set("openkill", "config", "operation_mode", "fake-ip")
		uci:commit("openkill")
	else
		uci:set("openkill", "config", "operation_mode", "redir-host")
		uci:commit("openkill")
	end
	HTTP.prepare_content("application/json")
	HTTP.write_json({
...
function action_status()
	...
	local result = {
		...
		openvpn_retained = openvpn_value("retained", "0"),
		openvpn_reason = openvpn_value("reason", "not-started"),
		openvpn_protocol_family = openvpn_value("protocol_family", "all"),
...
function action_start()
	...
	local logfile = "/tmp/openkill_start.log"
	...
	if pattern then
		cmd = string.format(
			...
			"fi; " ..
			"fi; " ..
			"liveness=$($PS_CMD | grep -v grep | grep \"$pattern\" | grep -v \"openkill_start\" | grep -c \"^\"); " ..
...
function action_save_github_address_mod()
	...
	uci:set("openkill", "config", "github_address_mod", value)
	uci:commit("openkill")
	HTTP.prepare_content("application/json")
	HTTP.write_json({
		success = true;
...
function action_close_all_connection()
	return SYS.call("sh /usr/share/openkill/openkill_history_get.sh 'close_all_conection'")
end

function action_reload_firewall()
	return SYS.call("/etc/init.d/openkill reload 'manual' >/dev/null 2>&1 &")
end
...
function action_refresh_log()
	HTTP.prepare_content("application/json")
	local logfile = "/tmp/openkill.log"
...
function action_del_log()
	...
	if log_type == "debug" then
		SYS.exec(": > /tmp/openkill_debug.log")
	else
		SYS.exec(": > /tmp/openkill.log")
	end
	return
end
...
function action_gen_debug_logs()
	...
	local cmd = string.format(
		"logfile='%s'; : > \"$logfile\"; " ..
		"/usr/share/openkill/openkill_debug.sh >/dev/null 2>&1 & DEBUG_PID=$!; " ..
...
function action_backup()
	local config = SYS.call("cp /etc/config/openkill /etc/openkill/openkill >/dev/null 2>&1")
	local reader = ltn12_popen("exec tar -C '/etc/openkill/' -cz . 2>/dev/null")

	HTTP.header(
		'Content-Disposition', 'attachment; filename="Backup-OpenKill-%s-%s-%s.tar.gz"' %{
	...
	luci.ltn12.pump.all(reader, HTTP.write)
	reader.kill()
	SYS.call("rm -rf /etc/openkill/openkill >/dev/null 2>&1")
end

function action_backup_ex_core()
	local config = SYS.call("cp /etc/config/openkill /etc/openkill/openkill >/dev/null 2>&1")
	local reader = ltn12_popen("echo 'core' > /tmp/oc_exclude.txt && exec tar -C '/etc/openkill/' -X '/tmp/oc_exclude.txt' -cz . 2>/dev/null")

	HTTP.header(
		'Content-Disposition', 'attachment; filename="Backup-OpenKill-Exclude-Cores-%s-%s-%s.tar.gz"' %{
			device_name, device_arh, os.date("%Y-%m-%d-%H-%M-%S")
		})
...
function action_backup_only_config()
	local reader = ltn12_popen("exec tar -C '/etc/openkill' -cz './config' 2>/dev/null")

	HTTP.header(
		'Content-Disposition', 'attachment; filename="Backup-OpenKill-Config-%s-%s-%s.tar.gz"' %{
			device_name, device_arh, os.date("%Y-%m-%d-%H-%M-%S")
		})
...
function action_backup_only_core()
	local reader = ltn12_popen("exec tar -C '/etc/openkill' -cz './core' 2>/dev/null")

	HTTP.header(
		'Content-Disposition', 'attachment; filename="Backup-OpenKill-Cores-%s-%s-%s.tar.gz"' %{
			device_name, device_arh, os.date("%Y-%m-%d-%H-%M-%S")
		})
...
function action_backup_only_rule()
	local reader = ltn12_popen("exec tar -C '/etc/openkill' -cz './rule_provider' 2>/dev/null")

	HTTP.header(
		'Content-Disposition', 'attachment; filename="Backup-OpenKill-Only-Rule-Provider-%s-%s-%s.tar.gz"' %{
			device_name, device_arh, os.date("%Y-%m-%d-%H-%M-%S")
		})
...
function action_backup_only_proxy()
	local reader = ltn12_popen("exec tar -C '/etc/openkill' -cz './proxy_provider' 2>/dev/null")

	HTTP.header(
		'Content-Disposition', 'attachment; filename="Backup-OpenKill-Proxy-Provider-%s-%s-%s.tar.gz"' %{
			device_name, device_arh, os.date("%Y-%m-%d-%H-%M-%S")
		})
...
function rename_file()
	...
	local old_run_file_path = "/etc/openkill/" .. old_file_name
	local new_run_file_path = "/etc/openkill/" .. new_file_name
	if fs.rename(old_file_path, new_file_path) then
		if file_path == "/etc/openkill/config/" then
			if fs.uci_get_config("config", "config_path") == old_file_path then
				uci:set("openkill", "config", "config_path", new_file_path)
			end
...
function action_cdn_info()
	...
	local cache_file = "/tmp/openkill_cdn_info.json"
...
function action_proxy_info(internal)
	...
	uci:foreach("openkill", "authentication", function(section)
...
function action_switch_oc_setting()
	...
	local function get_runtime_config_path()
		...
		return "/etc/openkill/" .. config_filename
	end
	...
	if setting == "meta_sniffer" then
			...
			if value == "1" then
				ruby_cmd = string.format([[
					...
					begin
						...
						custom_sniffer_path = '/etc/openkill/custom/openkill_custom_sniffer.yaml'
		...
		uci:set("openkill", "config", "enable_meta_sniffer", tonumber(value))
		uci:set("openkill", "config", "enable_meta_sniffer_pure_ip", tonumber(value))
		uci:set("openkill", "@overwrite[0]", "enable_meta_sniffer", tonumber(value))
		uci:set("openkill", "@overwrite[0]", "enable_meta_sniffer_pure_ip", tonumber(value))
		uci:commit("openkill")
	elseif setting == "respect_rules" then
		...
		uci:set("openkill", "config", "enable_respect_rules", tonumber(value))
		uci:set("openkill", "@overwrite[0]", "enable_respect_rules", tonumber(value))
		uci:commit("openkill")
	elseif setting == "oversea" then
		oversea_v6_setting = fs.uci_get_config("config", "ipv6_enable") or "0"
		if oversea_v6_setting ~= "0" then
			uci:set("openkill", "config", "china_ip6_route", value)
		end
		uci:set("openkill", "config", "china_ip_route", value)
		uci:commit("openkill")
		if is_running() then
			if oversea_v6_setting ~= "0" then
				uci:set("openkill", "@overwrite[0]", "china_ip6_route", value)
			end
			uci:set("openkill", "@overwrite[0]", "china_ip_route", value)
			uci:commit("openkill")
			SYS.exec("/etc/init.d/openkill restart >/dev/null 2>&1 &")
		end
	elseif setting == "stream_unlock" then
		uci:set("openkill", "config", "stream_auto_select", value)
		if not fs.uci_get_config("config", "stream_auto_select_interval") then
			uci:set("openkill", "config", "stream_auto_select_interval", "10")
		end
		if not fs.uci_get_config("config", "stream_auto_select_logic") then
			uci:set("openkill", "config", "stream_auto_select_logic", "Urltest")
		end
		if not fs.uci_get_config("config", "stream_auto_select_expand_group") then
			uci:set("openkill", "config", "stream_auto_select_expand_group", "0")
		end

		uci:set("openkill", "config", "stream_auto_select_netflix", "1")
		if not fs.uci_get_config("config", "stream_auto_select_group_key_netflix") then
			uci:set("openkill", "config", "stream_auto_select_group_key_netflix", "Netflix|奈飞")
		end

		uci:set("openkill", "config", "stream_auto_select_disney", "1")
		if not fs.uci_get_config("config", "stream_auto_select_group_key_disney") then
			uci:set("openkill", "config", "stream_auto_select_group_key_disney", "Disney|迪士尼")
		end

		uci:set("openkill", "config", "stream_auto_select_hbo_max", "1")
		if not fs.uci_get_config("config", "stream_auto_select_group_key_hbo_max") then
			uci:set("openkill", "config", "stream_auto_select_group_key_hbo_max", "HBO|HBO Max")
		end
		uci:commit("openkill")
	else
...
function action_generate_pac()
	...
	local pac_dir = "/www/luci-static/resources/openkill/pac/"
...
function generate_pac_url_with_client_info(pac_filename, random_suffix)
	...
	local pac_url = request_scheme .. "://" .. host .. "/luci-static/resources/openkill/pac/" .. pac_filename .. "?v=" .. random_param
...
function generate_pac_content(proxy_ip, proxy_port, auth_user, auth_pass)
	...
	local ipv4_networks = {}
	local ipv4_file = "/etc/openkill/custom/openkill_custom_localnetwork_ipv4.list"
	...
	local ipv6_networks = {}
	local ipv6_file = "/etc/openkill/custom/openkill_custom_localnetwork_ipv6.list"
...
local function kill_process()
	local cmd = string.format("%s |grep -E 'openkill|clash|mihomo' |grep -v grep |awk '{print $1}' |xargs -r kill -9 >/dev/null 2>&1", fs.ps_cmd())
	SYS.call(cmd)
end
...
function action_oc_action()
	...
	if config_file and config_file ~= "" then
		local config_path = "/etc/openkill/config/" .. config_file
	...
	if action == "start" then
		...
		if not is_running() then
			kill_process()
			SYS.call("/etc/init.d/openkill start >/dev/null 2>&1")
		else
			SYS.call("/etc/init.d/openkill restart >/dev/null 2>&1")
		end
...
function action_config_file_list()
	...
	uci:foreach("openkill", "config_age_secret", function(a)
		if a.name and (a.secret or a.public) then
			...
			uci:delete("openkill", "config_age_secret", a[".name"])
			uci:commit("openkill")
		end
	end)

	local config_dir = "/etc/openkill/config/"
...
function action_config_file_read()
	...
	local allow = false
	if config_file == "/etc/openkill/custom/openkill_custom_overwrite.sh" then
		allow = true
	elseif config_file:match("^/etc/openkill/overwrite/[^/]+$") and not string.find(config_file, "%.%.") then
		allow = true
	elseif config_file:match("^/etc/openkill/[^/]+%.ya?ml$") then
		allow = true
	elseif config_file:match("^/etc/openkill/config/[^/]+%.ya?ml$") and not string.find(config_file, "%.%.") then
		allow = true
	end
...
function action_config_file_save()
	...
	local is_overwrite = (config_file == "/etc/openkill/custom/openkill_custom_overwrite.sh" or config_file:match("^/etc/openkill/overwrite/[^/]+$"))

	if not is_overwrite then
		if not string.match(config_file, "^/etc/openkill/config/[^/]+%.ya?ml$") or string.find(config_file, "%.%.") then
			HTTP.write_json({
				status = "error",
				message = "Invalid config file path"
			})
		...
		if not (config_file == "/etc/openkill/custom/openkill_custom_overwrite.sh" or (config_file:match("^/etc/openkill/overwrite/[^/]+$") and not string.find(config_file, "%.%."))) then
			HTTP.write_json({
				status = "error",
...
function action_add_subscription()
	...
	uci:foreach("openkill", "config_subscribe", function(s)
		if s.name == name then
	...
	if existing_section_id then
		...
		section_id = uci:add("openkill", "config_subscribe")
	end

	if section_id then
		uci:set("openkill", section_id, "name", name)
		if normalized_address and normalized_address ~= "" then
			uci:set("openkill", section_id, "address", normalized_address)
		else
			uci:delete("openkill", section_id, "address")
		end
		uci:set("openkill", section_id, "sub_ua", sub_ua)

		uci:delete("openkill", section_id, "sub_headers")
		if sub_headers and sub_headers ~= "" then
			local headers = {}
			...
			if #headers > 0 then
				uci:set_list("openkill", section_id, "sub_headers", headers)
			end
		end

		uci:set("openkill", section_id, "sub_convert", sub_convert)
		if sub_convert == "1" then
			uci:set("openkill", section_id, "convert_address", convert_address)
			uci:set("openkill", section_id, "template", template)
			if template == "0" then
				uci:set("openkill", section_id, "custom_template_url", custom_template_url)
			else
				uci:delete("openkill", section_id, "custom_template_url")
			end
		else
			uci:delete("openkill", section_id, "convert_address")
			uci:delete("openkill", section_id, "template")
			uci:delete("openkill", section_id, "custom_template_url")
		end
		uci:set("openkill", section_id, "emoji", emoji)
		uci:set("openkill", section_id, "udp", udp)
		uci:set("openkill", section_id, "skip_cert_verify", skip_cert_verify)
		uci:set("openkill", section_id, "sort", sort)
		uci:set("openkill", section_id, "node_type", node_type)
		uci:set("openkill", section_id, "rule_provider", rule_provider)

		uci:delete("openkill", section_id, "custom_params")
		if custom_params and custom_params ~= "" and sub_convert == "1" then
			...
			if #params > 0 then
				uci:set_list("openkill", section_id, "custom_params", params)
			end
		end

		uci:delete("openkill", section_id, "keyword")
		if keyword and keyword ~= "" then
			...
			if #keywords > 0 then
				uci:set_list("openkill", section_id, "keyword", keywords)
			end
		end

		uci:delete("openkill", section_id, "ex_keyword")
		if ex_keyword and ex_keyword ~= "" then
			...
			if #ex_keywords > 0 then
				uci:set_list("openkill", section_id, "ex_keyword", ex_keywords)
			end
		end

		uci:set("openkill", section_id, "de_ex_keyword", de_ex_keyword)
...
function action_upload_overwrite()
	...
	local overwrite_dir = "/etc/openkill/overwrite/"
	...
	local file_size = string.len(upload)
	if file_size > 10 * 1024 * 1024 then
		HTTP.write_json({status = "error", message = string.format("File size (%s) exceeds 10MB limit", require("luci.openkill").filesize(file_size))})
		return
	end
	local fp = io.open(target_path, "w")
	if fp then
		...
		uci:foreach("openkill", "config_overwrite", function(s)
			if s.name == section_name then
				found = true
				uci:delete("openkill", s[".name"], "config")
				if #config_values > 0 then
					uci:set_list("openkill", s[".name"], "config", config_values)
				end
				if s.enable == nil or (s.enable ~= nil and enable ~= nil) then
					if enable == nil then
						enable = 0
					end
					uci:set("openkill", s[".name"], "enable", tostring(enable))
				end
				if s.order == nil or (s.order ~= nil and s.order ~= order and order ~= nil) then
					...
					uci:set("openkill", s[".name"], "order", order)
				else
					uci:set("openkill", s[".name"], "order", tonumber(order))
				end
				return false
			end
		end)
		if not found then
			local sid = uci:add("openkill", "config_overwrite")
			uci:set("openkill", sid, "name", section_name)
			uci:set("openkill", sid, "type", "file")
			uci:delete("openkill", sid, "config")
			if #config_values > 0 then
				uci:set_list("openkill", sid, "config", config_values)
			end
			if enable ~= nil then
				uci:set("openkill", sid, "enable", tostring(enable))
			else
				uci:set("openkill", sid, "enable", 0)
			end
			if order ~= nil then
				uci:set("openkill", sid, "order", tostring(order))
			else
				local max_order = -1
				uci:foreach("openkill", "config_overwrite", function(s)
					local o = tonumber(s.order)
				...
				uci:set("openkill", sid, "order", tostring(max_order + 1))
			end
		end
...
function action_overwrite_subscribe_info()
	...
	elseif method == "POST" then
		...
		if old_section_name and old_section_name ~= "" and old_section_name ~= section_name then
			uci:foreach("openkill", "config_overwrite", function(s)
				if s.name == old_section_name then
					uci:set("openkill", s[".name"], "name", section_name)
					uci:set("openkill", s[".name"], "url", url)
					uci:delete("openkill", s[".name"], "config")
					if #config_values > 0 then
						uci:set_list("openkill", s[".name"], "config", config_values)
					end
					uci:set("openkill", s[".name"], "update_days", update_days)
					uci:set("openkill", s[".name"], "update_hour", update_hour)
					uci:set("openkill", s[".name"], "type", typ)
					uci:set("openkill", s[".name"], "param", param)
					if s.order == nil or (s.order ~= nil and s.order ~= order and order ~= nil) then
						if order == nil then
							local max_order = -1
							uci:foreach("openkill", "config_overwrite", function(s)
						...
						uci:set("openkill", s[".name"], "order", tonumber(order) or 1)
					end
					if s.enable == nil or (s.enable ~= nil and enable ~= nil) then
						if enable == nil then
							enable = 0
		...
		if not found then
			local sid = uci:add("openkill", "config_overwrite")
			uci:set("openkill", sid, "name", section_name)
			uci:set("openkill", sid, "url", url)
			uci:delete("openkill", sid, "config")
			if #config_values > 0 then
				uci:set_list("openkill", sid, "config", config_values)
			end
			uci:set("openkill", sid, "update_days", update_days)
			uci:set("openkill", sid, "update_hour", update_hour)
			uci:set("openkill", sid, "type", typ)
			uci:set("openkill", sid, "param", param)
			if order == nil then
				local max_order = -1
				uci:foreach("openkill", "config_overwrite", function(s)
					local o = tonumber(s.order)
			...
			uci:set("openkill", sid, "order", order)
			uci:set("openkill", sid, "enable", 0)
		end
		uci:commit("openkill")
...
function action_overwrite_file_list()
	...
	local custom_file = "/etc/openkill/custom/openkill_custom_overwrite.sh"

	if fs.access(custom_file) then
		local stat = fs.stat(custom_file)
		if stat and stat.type == "regular" then
			table.insert(overwrite_files, {
				name = "openkill_custom_overwrite.sh",
				path = custom_file,
				size = stat.size,
				mtime = stat.mtime
			})
...
function delete_overwrite_file()
	...
	for idx, item in ipairs(order_list) do
		uci:set("openkill", item.section, "order", tostring(idx - 1))
	end
	uci:commit("openkill")
	...
	uci:foreach("openkill", "config_subscribe", function(s)
		if s.name == filename then
			...
			for _, field in ipairs({"sub_headers", "keyword", "ex_keyword", "custom_params"}) do
				local raw = uci:get_list("openkill", sid, field)
				if raw then
...
function action_subconverter_version()
	...
	local cmd = table.concat({
		...
		"-H " .. util.shellquote("Origin: https://openkill.local"),
		"-H " .. util.shellquote("Sec-Fetch-Mode: cors"),
		"-H " .. util.shellquote("Sec-Fetch-Dest: empty"),
		"-H " .. util.shellquote("User-Agent: OpenKill Subconverter Version Check"),
...
function action_add_age_config()
	...
	uci:foreach("openkill", "config_age_secret", function(s)
		if s.name == name then
	...
	if not age_section_id and (age_secret ~= "" or age_public ~= "" or age_algo ~= "") then
		age_section_id = uci:add("openkill", "config_age_secret")
		if age_section_id then
			uci:set("openkill", age_section_id, "name", name)
		end
	end

	if age_section_id then
		if (age_secret == "" and age_public == "") then
			uci:delete("openkill", age_section_id)
		else
			if age_secret and age_secret ~= "" then
				uci:set("openkill", age_section_id, "secret", age_secret)
			else
				uci:delete("openkill", age_section_id, "secret")
			end
			if age_public and age_public ~= "" then
				uci:set("openkill", age_section_id, "public", age_public)
			else
				uci:delete("openkill", age_section_id, "public")
			end
			if age_algo and age_algo ~= "" then
				uci:set("openkill", age_section_id, "algo", age_algo)
			else
				uci:delete("openkill", age_section_id, "algo")
			end
		end
		uci:commit("openkill")
	end
