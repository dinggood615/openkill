...
# This script is called by /etc/init.d/openkill
# Add your custom overwrite scripts here, they will be take effict after the OpenKill own srcipts
...
CONFIG_FILE="$1"
    ...
    #ruby_arr_add_file "$CONFIG_FILE" "['dns']['fallback-filter']['ipcidr']" "0" "/etc/openkill/custom/openkill_custom_fallback_filter.yaml" "['fallback-filter']['ipcidr']"
