...
local proxies = {}
local tested_proxy = {}
local unlock_cache_file = "/etc/openkill/history/streaming_unlock_cache"
...
local self_status = SYS.exec(string.format('ps -w |grep -v grep |grep -c "openkill_streaming_unlock.lua %s"', type))
