// ============================================================
// CodeMirror 6 Bundle — OpenKill
// Build: npx esbuild tools/codemirror/entry.js --bundle --format=iife --global-name=CM6 --minify --target=es2019 --outfile=root/www/luci-static/resources/openkill/js/cm6.min.js --legal-comments=none --loader:.css=text
// ============================================================
