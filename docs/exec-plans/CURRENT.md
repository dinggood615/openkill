...
- Next action: review the final diff, commit the bounded master change, push it, and verify Development CI for the resulting commit before preparing any RC artifact or device mutation.
