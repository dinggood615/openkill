...
- Next action: verify the documentation-only follow-up commit, then keep RC build and device installation behind the separately authorized candidate/device stages.
